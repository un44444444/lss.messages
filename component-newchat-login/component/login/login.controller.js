        ...
        if(!vm.user.username && !vm.user.password){
            ...
            AuthService.login(user,function (userinfo) {
                ...
                MenuService.init(userinfo.userid,function (friendchatidList,groupchatidList,chatroomchatidList,announcechatidList) {
                    ...
                    //订阅聊天室
                    var mqttLoginInfo = {friendchatidList:friendchatidList,groupchatidList:groupchatidList,chatroomchatidList:chatroomchatidList,announcechatidList:announcechatidList,};
